...
import { Shield, Key, Fingerprint, Mail, Lock } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-corporate-900 text-white relative overflow-hidden flex-col items-center justify-center p-6">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-10 space-y-4">
           ...
           <h1 className="text-3xl font-bold tracking-tight">FortisMail</h1>
          ...
          <AnimatePresence mode="wait">
             ...
             {status === 'generatingKeys' && (
                ...
                >
                   ...
                   <p className="text-xs text-corporate-400 font-mono text-center"><span className="text-accent-blue font-bold">RSA-4096</span> Key material derived.</p>
                </motion.div>
             )}
          </AnimatePresence>
        </div>
